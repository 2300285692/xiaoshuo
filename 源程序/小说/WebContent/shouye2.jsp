...
<BODY onLoad="gettime()">
   ...
   <input type="button" name="jump" value="增加小说" onclick="location.href='tianjia.jsp'">
    ...
    <div id="tabDiv" style="width: 1000px">
       ...
       <div id="tabContent1" style="display: block">
			...
			while(rs1.next()){
				...
				out.println("<td>"+rs1.getString(1)+"-----"+rs1.getString(2)+"</td>");
				out.println("<td><a href='shanchu.jsp?shuming="+rs1.getString(1)+"'>删除</a><a href='xiugai.jsp?shuming="+rs1.getString(1)+"'>修改</a></td>");
				out.println("<tr>");
			}
            %>
            </table>
        ...
        <div id="tabContent2" style="display: none">
         ...
         <%
			...
			while(rs2.next()){
				...
				out.println("<td><a href='shanchu.jsp?shuming="+rs2.getString(1)+"'>删除</a><a href='xiugai.jsp?shuming="+rs2.getString(1)+"'>修改</a></td>");
				out.println("<tr>");
			}
            %>
            </table>
           ...
           <%
			...
			while(rs3.next()){
				...
				out.println("<td>"+rs3.getString(1)+"-----"+rs3.getString(2)+"</td>");
				out.println("<td><a href='shanchu.jsp?shuming="+rs3.getString(1)+"'>删除</a><a href='xiugai.jsp?shuming="+rs3.getString(1)+"'>修改</a></td>");
				out.println("<tr>");
			}
            %>
            </table>
        ...
        <%
			...
			while(rs4.next()){
				...
				out.println("<td>"+rs4.getString(1)+"-----"+rs4.getString(2)+"</td>");
				out.println("<td><a href='shanchu.jsp?shuming="+rs4.getString(1)+"'>删除</a><a href='xiugai.jsp?shuming="+rs4.getString(1)+"'>修改</a></td>");
				out.println("<tr>");
			}
            %>
            </table>
        ...
        <%
			...
			while(rs5.next()){
				...
				out.println("<td>"+rs5.getString(1)+"-----"+rs5.getString(2)+"</td>");
				out.println("<td><a href='shanchu.jsp?shuming="+rs5.getString(1)+"'>删除</a><a href='xiugai.jsp?shuming="+rs5.getString(1)+"'>修改</a></td>");
				out.println("<tr>");
			}
            %>
            </table>
        ...
        <%
			...
			while(rs6.next()){
				...
				out.println("<td>"+rs6.getString(1)+"-----"+rs6.getString(2)+"</td>");
				out.println("<td><a href='shanchu.jsp?shuming="+rs6.getString(1)+"'>删除</a><a href='xiugai.jsp?shuming="+rs6.getString(1)+"'>修改</a></td>");
				out.println("<tr>");
			}
            %>
            </table>
        ...
        <%
			...
			while(rs7.next()){
				...
				out.println("<td>"+rs7.getString(1)+"-----"+rs7.getString(2)+"</td>");
				out.println("<td><a href='shanchu.jsp?shuming="+rs7.getString(1)+"'>删除</a><a href='xiugai.jsp?shuming="+rs7.getString(1)+"'>修改</a></td>");
				out.println("<tr>");
			}
            %>
            </table>		
